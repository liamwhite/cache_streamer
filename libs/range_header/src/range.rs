// This is the proper typed range header implementation taken from
// https://github.com/hyperium/headers/pull/93.
...
/// use range_header::{Range, ByteRangeBuilder};
///
...
mod test {
    ...
    use super::{ByteRangeBuilder, ByteRangeSpec, Range};
    use crate::test_decode;
